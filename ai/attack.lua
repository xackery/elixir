...
function attack:Cast(elixir)
    ...
    if self.attackCooldown and self.attackCooldown > mq.gettime() then string.format("on attack cooldown for %d seconds", math.ceil((self.attackCooldown-mq.gettime())/1000)) end
